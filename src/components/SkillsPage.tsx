...
const SkillsPage = () => {
  const skills: Skill[] = [
    ...
    },
    {
      ...
      category: "Backend Development",
      level: 90,
      description: "Enterprise Java applications and microservices development",
    },
    {
    ...
    },
    {
      ...
      category: "Database Management",
      level: 85,
      description: "In-memory data structure store and caching solutions",
    },
    {
      name: "Neon",
      icon: <Database className="h-6 w-6" />,
    ...
    },
    {
      ...
      category: "Database Management",
      level: 88,
      description: "Real-time NoSQL database and backend services",
    },
    {
      name: "Supabase",
      icon: <Database className="h-6 w-6" />,
    ...
    },
    {
      ...
      category: "Cloud Computing",
      level: 82,
      description: "Google Cloud services, compute engine, and cloud functions",
    },
    {
    ...
    },
    {
      ...
      category: "Cloud Computing",
      level: 75,
      description: "Alibaba Cloud services and infrastructure solutions",
    },
    {
      name: "UI/UX Design",
    ...
    },
    {
      ...
      category: "Project Management",
      level: 93,
      description: "Project tracking and agile project management",
    },
    {
      name: "Kanban",
      icon: <Zap className="h-6 w-6" />,
      category: "Project Management",
      level: 88,
      description: "Visual workflow management and process optimization",
    },
    {
      name: "Linux",
      ...
      level: 91,
      description: "Linux system administration and server management",
    },
    {
      ...
      category: "System Administration",
      level: 89,
      description: "Bash scripting and automation for system tasks",
    },
  ];
